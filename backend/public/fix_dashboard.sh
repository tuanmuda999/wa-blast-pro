...
# Backup old version
cp dashboard.js dashboard.js.CONTAMINATED_$(date +%s)

# Create clean version
cat > dashboard.js << 'DASHBOARDEOF'
...
echo ""
echo "✅ CLEAN dashboard.js created!"
echo "✅ NO chrome.runtime code"
echo "✅ All features preserved"
echo ""
echo "Next steps:"
echo "1. Restart PM2: pm2 restart wa-blast-pro"
echo "2. Clear browser cache: Ctrl+Shift+Delete"
echo "3. Hard refresh: Ctrl+Shift+R (multiple times)"
echo "4. Test: Create session → Should work now!"
echo ""
